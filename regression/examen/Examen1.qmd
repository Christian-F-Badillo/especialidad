...
En la @fig-componentes_codo se observa el gráfico de codo de los componentes principales. Se observa que los primeros 3 componentes explican el 55.1% de la varianza total y es donde se observa la curvatura del gráfico, sin embargo la varianza explicada es muy poca, por lo cual se debe escoger un número mayor de componentes para explicar la varianza. 

Dado a partir del componente 8 el aumento de la varianza explicada es muy pequeño, se procederá a usar 8 componentes principales.